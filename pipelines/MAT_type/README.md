...
This is an ugly, hardcoded, redundant script to visualize the depth profiles of the MAT alignments for the 11 strains (plus a control for both MAT-1 ad MAT-2) with significant alignments to both idiomorphs (included as a supplemental figure in the manuscript). 

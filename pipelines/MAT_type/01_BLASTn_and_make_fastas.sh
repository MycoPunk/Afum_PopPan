...
for i in *.rename.fa; do
blastn -query ../fastas/MAT1-1_AY898661.1_whole_gene.nt  -db $i -evalue .0001 -outfmt "6 sseqid sseq" -word_size 10 -out $i.MAT1-1.forfasta.out
done

for i in *.rename.fa; do
blastn -query ../fastas/MAT1-2_Afu3g06170_whole_gene.nt  -db $i -evalue .0001 -outfmt "6 sseqid sseq" -word_size 10 -out $i.MAT1-2.forfasta.out
done
